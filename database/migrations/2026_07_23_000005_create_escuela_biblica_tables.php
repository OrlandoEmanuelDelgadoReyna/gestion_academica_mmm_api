...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('programaciones_academicas')) {
        ...
        if (! Schema::hasTable('programacion_estados_membresia_permitidos')) {
            Schema::create('programacion_estados_membresia_permitidos', function (Blueprint $table): void {
                ...
                $table->timestamps();
                $table->unique(['programacion_academica_id', 'estado_membresia_id'], 'uk_prog_estado_perm');
        ...
        if (! Schema::hasTable('programacion_docentes')) {
            Schema::create('programacion_docentes', function (Blueprint $table): void {
                ...
                $table->timestamps();
                $table->unique(['programacion_academica_id', 'miembro_id'], 'uk_prog_doc_miembro');
        ...
        if (! Schema::hasTable('sesion_lecciones')) {
        ...
        if (! Schema::hasTable('entregas_tarea')) {
