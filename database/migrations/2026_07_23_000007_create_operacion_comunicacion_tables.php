...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('tipos_certificado')) {
        ...
        if (! Schema::hasTable('tipos_culto')) {
        ...
        if (! Schema::hasTable('tipos_participacion')) {
        ...
        if (! Schema::hasTable('bloques_culto')) {
        ...
        if (! Schema::hasTable('participaciones_culto')) {
        ...
        if (! Schema::hasTable('dispositivos_notificacion')) {
