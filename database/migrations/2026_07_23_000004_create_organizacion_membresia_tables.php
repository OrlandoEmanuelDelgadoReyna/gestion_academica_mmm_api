...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (! Schema::hasTable('estados_membresia')) {
        ...
        if (! Schema::hasTable('miembro_cargos')) {
        ...
        if (! Schema::hasTable('miembro_sociedades')) {
        ...
        if (! Schema::hasTable('transiciones_estado_membresia')) {
        ...
        if (! Schema::hasTable('historial_membresia')) {
